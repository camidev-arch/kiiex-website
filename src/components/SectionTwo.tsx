...
const SectionTwo = () => {
  return (
    ...
    <Title className='title-col-two-two' >
        ...
        <Button className='boton-comienza-ahora2' style={{ height:'50px',  width:'230px',  fontSize:'20px',margin:'10px'}}>Regístrate aquí <ArrowRigth color='white' width='20px' heigth='20px' /></Button>
    </Col>
</Row>
  )
}
